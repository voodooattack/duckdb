...
using const_void_p_array = const void *[];
using void_p_array = void *[];
/* Destroy any non-null GEOSGeometry* pointers passed as arguments */
#define GEOS_FREE(...)                                                                                                 \
	do {                                                                                                               \
		geos_destroy((sizeof(void_p_array {__VA_ARGS__}) / sizeof(void *)), __VA_ARGS__);                                \
	} while (0)
...
#define RESULT_SRID(...)                                                                                               \
	(get_result_srid((sizeof(const_void_p_array {__VA_ARGS__}) / sizeof(void *)), __func__, __VA_ARGS__))
