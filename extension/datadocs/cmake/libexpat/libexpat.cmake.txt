...
option(EXPAT_ENABLE_INSTALL "install expat files in cmake install target" OFF)
...
include(cmake/libexpat/libexpat.ConfigureChecks.cmake)
...
configure_file(${CMAKE_CURRENT_BINARY_DIR}/libexpat/expat/expat_config.h.cmake "${CMAKE_CURRENT_BINARY_DIR}/libexpat-build/expat_config.h")
...
include_directories(${CMAKE_CURRENT_BINARY_DIR}/libexpat-build ${CMAKE_CURRENT_BINARY_DIR}/libexpat/expat/lib)
if(MSVC)
...
#
set(expat_SRCS
    ${CMAKE_CURRENT_BINARY_DIR}/libexpat/expat/lib/xmlparse.c
    ${CMAKE_CURRENT_BINARY_DIR}/libexpat/expat/lib/xmlrole.c
    ${CMAKE_CURRENT_BINARY_DIR}/libexpat/expat/lib/xmltok.c
...
target_include_directories(${EXPAT_TARGET}
    INTERFACE
        $<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}/libexpat/expat/lib>
        $<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}/libexpat-build>
